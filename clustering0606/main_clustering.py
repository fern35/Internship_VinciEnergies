# Q: 1. Int_Solde & Pan_Solde are different, why?
# 2. what is 'pan_SourceEqt'?
...
3. for the non-standard categorical variables, use NLP detect the classes automatically
"""
...
# dict_encode_pan_Solde, data_Int_encode = cluster.cat_encode(data=data_Int_encode, var='pan_Solde', regroup_dict={'Solde':['Soldé','Mise en sécurité'],'Provision':['Mise en provisoire'], 'Nonsolde':['Problème non résolu','Mise en attente','En cours']})
# dict_encode_int_Solde, data_Int_encode = cluster.cat_encode(data=data_Int_encode, var='int_Solde', regroup_dict={'Solde':['Soldé','Mise en sécurité'],'Provision':['Mise en provisoire'], 'Nonsolde':['Problème non résolu','Mise en attente','En cours'],'NA':['NA']})
